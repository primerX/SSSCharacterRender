...
#if defined(_NORMALMAP) || defined(_BENTNORMALMAP) || defined(_COATNORMALMAP) || defined(_DETAIL) || defined(_RAIN_NORMALMAP)
    #define _NORMAL
#endif
...
inline void InitializeSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    ...
    outSurfaceData.bentNormalTS = SampleBentNormal(uv, TEXTURE2D_ARGS(_BentNormalMap, SAMPLER_NORMALMAP_IDX), _NormalScale);
    outSurfaceData.coatNormalTS = SampleCoatNormal(uv, TEXTURE2D_ARGS(_CoatNormalMap, SAMPLER_NORMALMAP_IDX), _CoatNormalScale);

...
namespace KeroTools.URPPlus.Runtime
{
    ...
    public class URPPlusSettings : MonoBehaviour
    {
        ...
        [SerializeField] private IridescenceModel _iridescenceModel;
        [SerializeField] private SheenModel _sheenModel;
        ...
        {
            bool sssLUT = _sssModel == 1;
            useIridescenceLUT = _iridescenceModel is IridescenceModel.Approximation;
            bool sheenMode = _sheenModel is SheenModel.PhysicalBased;

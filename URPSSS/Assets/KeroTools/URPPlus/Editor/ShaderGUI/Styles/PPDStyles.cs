...
namespace KeroTools.URPPlus.Editor.ShaderGUI.Styles
{
    ...
    public static class PPDStyles
    {
        ...
        public static readonly GUIContent DepthOffsetEnable = EditorGUIUtility.TrTextContent("Depth Offset",
            "When enabled, URP+ uses the Height Map to calculate the depth offset for this Material.");
    }
}
...
{
    public static class EmissionInputsStyles
    {
        public static readonly GUIContent Label = EditorGUIUtility.TrTextContent("Emission Inputs");

        public static readonly GUIContent EnableEmission =
            EditorGUIUtility.TrTextContent("Enable Emission", "Specifies the emissive color (RGB) of the Material.");
        ...
        public static readonly GUIContent EmissionFresnelPower =
            EditorGUIUtility.TrTextContent("Emission Fresnel Power", "Sets the power value for emission fresnel.");
    }
}
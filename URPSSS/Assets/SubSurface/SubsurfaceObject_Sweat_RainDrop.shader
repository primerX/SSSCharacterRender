Shader "Shenkong/SSS MyOjbect Sweat RainDrop"
{
    Properties
    {
        ...
        // [Space]
        // [Header(SweatSettin)]
        // _SweatMap("Sweat Map", 2D) = "white" {}
        // _DropCellAspect("Drop Cell Aspect", Vector) = (1, 1, 1, 1)
        // _DropSize("Drop Size", Vector) = (1, 1, 1, 1)
        // _DropParams("Drop Parms", Vector) = (1, 1, 1, 1)
        // _SweatSize("Sweat Size", Vector) = (1, 1, 1, 1)
        // _TexRotMatr("帖图旋转矩阵", Vector) = (1, 0, 0, 1)

        [Space]
        [Header(WaterDrop)]
        [Toggle] _ArmWaterDrop("Arm Water Drop", Float) = 0
		...
		_RainAmount("_RainAmount", Range(0, 1)) = 0.3
		// _MinBlur("_MinBlur", Range(0, 10)) = 0
		// _MaxBlur("_MaxBlur", Range(0, 10)) = 1

		// _StaticRainDropSpeed("_StaticRainDropSpeed", Range(0, 0.2)) = 0.1
        ...
        // _StaticRainAmount("Static Rain Amount", Range(0, 1)) = 1
        // _DynamiceLayer1RainAmount("_DynamiceLayer1 RainAmount", Range(0.25, 1)) = 0.75
        // _DynamiceLayer2RainAmount("_DynamiceLayer2 RainAmount", Range(0, 1)) = 0.75

        // _FlowMap("Flow Map", 2D) = "white" {}
        // _FlowMapStrength("_FlowMapStrength", Float) = 1
        // _FlowDirection("_FlowDirection", Vector) = (1, 1, 0, 0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _ARMWATERDROP_ON

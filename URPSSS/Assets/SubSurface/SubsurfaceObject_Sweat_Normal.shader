Shader "Shenkong/SSS MyOjbect Sweat Normal"
{
    Properties
    {
        ...
        _Weatness("_Weatness", Range(0, 1)) = 1
        _WetnessColor("Wetness Color", Color) = (1, 1, 1, 1)

        _RainMaskMap("Rain MaskMap", 2D) = "white" {}

        _RainNormalMap ("_Rain NormalMap", 2D) = "bump" {}
        _RainNormalScale("_RainNormalScale", Range(0, 10)) = 1
        _RainSize("_RainSize", Range(0, 10)) = 1
        _RainAnimationSpeed("_RainAnimationSpeed", Range(0, 2)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input, bool isFacing : SV_IsFrontFace) : SV_Target
            {
                ...
                half smoothness = lerp(maskMap.r, 1, _Smoothness);

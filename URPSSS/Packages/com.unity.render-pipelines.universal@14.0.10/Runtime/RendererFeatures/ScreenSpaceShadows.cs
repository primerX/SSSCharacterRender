...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class ScreenSpaceShadows : ScriptableRendererFeature
    {
        ...
        private class ScreenSpaceShadowsPass : ScriptableRenderPass
        {
            ...
            private RTHandle m_SpotRenderTarget;
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                RenderingUtils.ReAllocateIfNeeded(ref m_SpotRenderTarget, desc, FilterMode.Point, TextureWrapMode.Clamp, name: "_SpotScreenSpaceShadowmapTexture");
                cmd.SetGlobalTexture(m_SpotRenderTarget.name, m_SpotRenderTarget.nameID);
                ConfigureTarget(m_SpotRenderTarget);
                ConfigureClear(ClearFlag.None, Color.white);
            }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                using (new ProfilingScope(cmd, m_ProfilingSampler))
                {
                    ...
                    Blitter.BlitCameraTexture(cmd, m_SpotRenderTarget, m_SpotRenderTarget, m_Material, 1);
        ...
        private class ScreenSpaceShadowsPostPass : ScriptableRenderPass
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                using (new ProfilingScope(cmd, m_ProfilingSampler))
                {
                    // Debug.Log("ScreenSpaceShadowsPostPass Execute");
